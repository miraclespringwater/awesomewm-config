return {
  global = {
    ...
    hotkey = {
      ...
      brightness_up         = function() os.execute("backlight_control +10") end,
      brightness_down       = function() os.execute("backlight_control -10") end,
      brightness_max        = function() os.execute("backlight_control 100") end,
    ...
    launch = {
      ...
      nvim     = function() awful.spawn("alacritty -e bash --rcfile /home/dream/.bashrc -c 'fff \"$@\"; cd \"$(cat \"${XDG_CACHE_HOME:=${HOME}/.cache}/fff/.fff_d\")\"; nvim'") end,
    },
    rofi = {
      run = function() awful.spawn("rofi -show run") end,
      pdf = function() awful.spawn("sh /home/dream/.config/rofi/scripts/zathura_selector.sh") end,
    }
  },
  client = {
    client = {

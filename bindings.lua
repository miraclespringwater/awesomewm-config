...
--{ { modkey,           },     "g",         "global",     "launch",     ""                              },
  ...
  { { modkey, "Shift"   },     "h",         "global",     "screen",     "focus_prev"                    },
  { { modkey, "Control" },     "h",         "global",     "tags",       "move_to_the_left"          },
  { { modkey,           },     "j",         "global",     "client",     "focus_down"                    },
  { { modkey, "Shift"   },     "j",         "global",     "client",     "swap_prev_by_index"            },
  { { modkey,           },     "k",         "global",     "client",     "focus_up"                      },
  { { modkey, "Shift"   },     "k",         "global",     "client",     "swap_next_by_index"            },
  { { modkey,           },     "l",         "global",     "client",     "focus_right"                   },
  { { modkey, "Shift"   },     "l",         "global",     "screen",     "focus_next"                    },

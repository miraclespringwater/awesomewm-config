...
local theme = {}
theme.confdir = os.getenv("HOME") .. "/.config/awesome/themes/dreamsmithOS_classic"
...
local function update_verse()
	get_random_bible_verse(function(verse)
		...
		bible_widget:get_children_by_id("label")[1].markup =
			markup.fontfg(theme.font, bright_purple, "󰳵 " .. verse:match("^(.-): "))
